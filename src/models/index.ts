...
export function weatherDesc(details: CurrentWeatherDetailsModel | DailyWeatherDetailsModel) {
  return details.conditionCode.replace(/([A-Z])/g, (x) => " " + x.toLowerCase()).replace(/^ /, "");
}
